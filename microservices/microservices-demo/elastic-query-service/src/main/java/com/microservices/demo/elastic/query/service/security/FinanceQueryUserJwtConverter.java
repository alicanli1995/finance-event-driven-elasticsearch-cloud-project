...
import static com.microservices.demo.elastic.query.service.util.Constants.NA;

@RequiredArgsConstructor
public class FinanceQueryUserJwtConverter implements Converter<Jwt, AbstractAuthenticationToken> {
    ...
    private final FinanceQueryUserDetailService userDetailService;
    ...
    public AbstractAuthenticationToken convert(Jwt jwt) {
        ...
        return Optional.ofNullable(
                        userDetailService.loadUserByUsername(jwt.getClaimAsString(USERNAME_CLAIM)))
                .map(userDetails -> {
                    ((FinanceQueryUser) userDetails).setAuthorities(authoritiesFromJwt);
