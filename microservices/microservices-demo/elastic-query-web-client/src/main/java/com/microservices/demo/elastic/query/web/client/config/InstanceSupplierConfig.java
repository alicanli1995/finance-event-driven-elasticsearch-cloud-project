...
@Primary
@Configuration
public class InstanceSupplierConfig implements ServiceInstanceListSupplier {

    private final ElasticQueryWebClientConfigData.WebClient webClientConfig;

    public InstanceSupplierConfig(ElasticQueryWebClientConfigData webClientConfigData) {
